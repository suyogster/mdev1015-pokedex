...
export default function PokemonDetailScreen(props: any) {
    ...
    return (
      <View style={styles.noDataContainer}>
        <Image
          ...
          source={defaultImage}
        />
        <Text>Sorry, couldn't fetch data as of now !</Text>
      </View>
    );
  }
  ...
  const addFavourites = (data: any) => {
    if (
      !favourites.some(
        (fav: { [x: string]: any; name: any }) => fav.name === data.name,
      )
    ) {
      ...
      >
        <View style={styles.customHeader}>
          ...
          <View style={styles.customHeaderRightIcons}>
            <TouchableOpacity onPress={() => addFavourites(data)}>
              <Image
      ...
      <View style={styles.statsSection}>
        ...
        <View style={styles.statsContentSection}>
          {page === 0 ? (
            ...
            <DetailStats attack={base_experience} hp={height} speed={order} />
          )}
        </View>
      </View>
    </SafeAreaView>
